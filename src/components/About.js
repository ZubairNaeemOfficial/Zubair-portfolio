...
const About = () => {
  ...
  const [state] = React.useState([
    { id: 1, title: "Name:", text: "Zubair Naeem" },
    { id: 2, title: "Email:", text: "zubairrajpoot4241@gmail.com" },
    { id: 3, title: "Phone:", text: "0317-7034183" },
    { id: 4, title: "Linkedin", text: "Zubair Rajpoot" },
  ]);
  return (
    <div className="about">
